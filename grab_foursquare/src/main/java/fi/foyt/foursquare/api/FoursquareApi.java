...
//      System.out.println(response.getResponse());
  ...
  public Result<VenuesSearchResult> venuesSearch(String ll, Double llAcc, Double alt, Double altAcc, String query, Integer limit, String intent, String categoryId, String url, String providerId, String linkedId, Integer radius, String near, String sw, String ne) throws FoursquareApiException {
	    try {
	      ApiRequestResponse response = doApiRequest(Method.GET, "venues/search", isAuthenticated(), "ll", ll, "llAcc", llAcc, "alt", alt, "altAcc", altAcc, "query", query, "limit", limit, "intent", intent, "categoryId", categoryId, "url", url, "providerId", providerId, "linkedId", linkedId, "radius", radius, "near", near,"sw",sw,"ne",ne);
	      VenuesSearchResult result = null;
//	      System.out.println(response.getResponse());
